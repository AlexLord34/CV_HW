...
\usepackage{Content/settings.sty}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Alex Gusev}

  \makefield{\faEnvelope[regular]}{\href{mailto:sasagusevvv@gmail.com}{\texttt{:sasagusevvv@gmail.com}}}
